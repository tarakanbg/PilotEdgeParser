namespace PilotEdgeToolbox
{
  partial class AboutBox1
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.labelProductName.Text = "Pilotedge Toolbox";
      ...
      this.labelCompanyName.Text = "Svilen Vassilev (N217S)";
      ...
      this.textBoxDescription.Text = "Who\'s Online monitor and toolbox for the Pilotedge network";
      // 
      // okButton
      // 
      ...
      this.Text = "About Pilotedge Toolbox";
